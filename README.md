...
| 프로젝트 이름 | 요약 | 링크 |
|---------------|------|-------|
| 매치업 | 성적 + 성격을 입력하면 팀을 매칭해주는 시스템 | 링크 |
| 관광버스 | 날씨 + 관광지 API → 감정에 맞는 여행 플래너 | 링크 |
| 깐부대출 | 친구 간 대출 기능을 지원하는 개인 금융 앱 | 링크 |
| 긴급차량 탐지 AI | 긴급차량 우선 통행 탐지 AI | 링크 |
| MOODI-TREE | 감정 기반 콘텐츠 및 활동 추천 AI 서비스 | 링크 |
